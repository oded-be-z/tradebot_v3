class ResponseFilter {
  ...
  generateRefusalMessage(query, classification, reason) {
    ...
    if (classification === "non-financial") {
      ...
      message +=
        " I need questions to be clearly related to financial markets or investing.";
    }
  ...
  filterResponse(response, query, classification) {
    ...
    if (containsNonFinancial) {
      return {
        ...
        filteredResponse: this.generateRefusalMessage(
          query,
          classification,
          "Response contained non-financial content",
        ),
