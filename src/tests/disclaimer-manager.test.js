...
describe("DisclaimerManager", () => {
  ...
  describe("risk assessment methods", () => {
    test("should detect high-risk terms", () => {
      ...
      expect(manager.containsHighRiskTerms("cryptocurrency investment")).toBe(
        true,
      );
  ...
  describe("content type identification", () => {
    ...
    test("should identify analysis content", () => {
      expect(manager.identifyContentType("technical analysis shows")).toBe(
        "analysis",
      );
    });
  ...
  describe("risk level assessment", () => {
    test("should assess high risk correctly", () => {
      expect(manager.assessRiskLevel("cryptocurrency options trading")).toBe(
        "high",
      );
    ...
    test("should assess medium risk correctly", () => {
      expect(manager.assessRiskLevel("growth stock momentum trading")).toBe(
        "medium",
      );
    });
  ...
  describe("utility methods", () => {
    ...
    test("should create custom disclaimers", () => {
      const custom = manager.getCustomDisclaimer(
        "warning",
        "Custom warning text",
      );
