...
describe("Integration Tests", () => {
  ...
  afterAll(() => {
    if (marketData && marketData.cleanup) {
      marketData.cleanup();
    }
  });
  ...
  describe("Crypto Query Flow", () => {
    ...
    test("should add crypto disclaimers to crypto advice", () => {
      const mockResponse =
        "You should definitely buy Bitcoin now as it's going to the moon!";
  ...
  describe("Financial Concepts Flow", () => {
    ...
    test("should handle options trading explanation", () => {
      ...
      const mockResponse =
        "Options are complex derivatives that give you the right to buy or sell stocks at specific prices.";
  ...
  describe("Complete Workflow Integration", () => {
    test("should process financial query from start to finish", async () => {
      ...
      const filterResult = filter.filterResponse(
        mockResponse,
        query,
        intentResult.classification,
      );
