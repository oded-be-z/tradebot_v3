...
describe("IntentClassifier", () => {
  ...
  describe("classifyIntent", () => {
    ...
    test("should identify greetings", () => {
      const greetings = ["Hello", "Hi there", "Good morning", "Hey"];
  ...
  describe("getFinancialIntentType", () => {
    ...
    test("should identify news requests", () => {
      const queries = ["Any news about Tesla?", "Latest updates on Apple"];
    ...
    test("should identify comparisons", () => {
      const queries = ["Apple vs Microsoft stock", "Compare AAPL and MSFT"];
  ...
  describe("details and metadata", () => {
    test("should provide detailed analysis", () => {
      const result = classifier.classifyIntent(
        "What's $AAPL and $MSFT price today?",
      );
    ...
    test("should track scores correctly", () => {
      const result = classifier.classifyIntent(
        "I love Apple stock and Microsoft shares",
      );
