class KnowledgeBase {
  constructor() {
    this.financialTerms = {
      stock:
        "A share of ownership in a company that entitles the holder to a portion of the company's assets and profits.",
      dividend:
        "A payment made by corporations to shareholders, usually as a distribution of profits.",
      "pe ratio":
        "Price-to-earnings ratio. A valuation ratio comparing a company's current share price to its per-share earnings.",
      "market cap":
      ...
      "moving average":
        "A calculation to analyze data points by creating averages of different subsets of data.",
      ...
      volume:
        "The number of shares traded in a security during a given period.",
      earnings: "A company's profit or net income for a specific period.",
      revenue:
        "The total amount of income generated by a company from its operations.",
      cryptocurrency: "A digital or virtual currency secured by cryptography.",
      blockchain:
        "A distributed ledger technology underlying most cryptocurrencies.",
      "market order":
      ...
      "swing trading":
        "Holding positions for several days to weeks to profit from price swings.",
      "fundamental analysis":
        "Evaluating a security by examining related economic and financial factors.",
      "technical analysis":
        "Analyzing statistical trends from trading activity to evaluate investments.",
    };
  ...
  getEducationalContent(topic) {
    const content = {
      investing_basics:
        "Investing involves putting money into financial instruments with the expectation of profit. Key principles include diversification, risk management, and long-term thinking.",
      risk_management:
        "Risk management involves identifying, assessing, and controlling threats to capital and earnings. This includes diversification, stop losses, and position sizing.",
      ...
      dollar_cost_averaging:
        "A strategy where you invest a fixed amount regularly regardless of market conditions, potentially reducing the impact of volatility.",
      technical_analysis:
      ...
      fundamental_analysis:
        "Evaluating a security by examining related economic and financial factors to determine its intrinsic value.",
    };
